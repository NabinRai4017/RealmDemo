...
class StaffsInDepartVC: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.staffsObserver()
        self.staffs = StaffsVM.getAllStaffsWith(_departId: departInfo.id)
        print(Realm.Configuration.defaultConfiguration.fileURL!)
        
        print(staffs?.count ?? 0)
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        return "\(departInfo.name)'s STAFFS"
    }
